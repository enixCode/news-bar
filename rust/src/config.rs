...
pub struct Config {
    ...
    pub segments: Vec<String>, // textes fixes du bandeau (rappels, raccourcis...)
    pub feeds: Vec<Feed>,
    pub refresh_minutes: u64,
    pub max_items_per_feed: usize,
    pub item_format: String, // gabarit avec {source} et {title}
    pub translate: bool, // traduire les titres (cle via GROQ_API_KEY)
    pub groq_model: String,
    pub language: String, // langue cible de traduction ("français" par défaut)
}
...
pub fn load() -> Config {
    ...
    Config {
        ...
        segments: j.segments.unwrap_or(d.segments),
        feeds,
        ...
        language: j.language.unwrap_or(d.language),
    }
}
