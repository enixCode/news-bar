...
pub fn translate_titles(titles: &[String], key: &str, model: &str) -> Option<Vec<String>> {
    if titles.is_empty() {
        return Some(Vec::new());
    }
    ...
    let payload = serde_json::json!({
        ...
        "messages": [
            {
                "role": "system",
                "content": "Tu traduis des titres d'actualite en francais naturel et concis. Reponds UNIQUEMENT un objet JSON de la forme {\"t\": [...]}, ou t est le tableau des traductions, dans le meme ordre et la meme longueur que l'entree. Ne traduis pas les noms propres."
            },
